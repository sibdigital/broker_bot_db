...
```
2. выполнить create_db_2020_08_12.sql
3. для тестирования корректности создания БД можно последовательно выполнить файлы заполнения данными, находящиеся в каталоге test
